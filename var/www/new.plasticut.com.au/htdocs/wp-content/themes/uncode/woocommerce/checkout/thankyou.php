 ...
 * Modifications:
 * 1. h3 instead of p
 * 2. custom uncode_woocommerce_thankyou_before_table action
 * 3. uncode_woocommerce_print_thankyou_table filter
 */
...
<div class="woocommerce-order">
	...
	if ( $order ) :
		...
		<?php else : ?>
			...
			<ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details">
				...
				<li class="woocommerce-order-overview__order order">
					...
					<strong><?php echo uncode_switch_stock_string( $order->get_order_number() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></strong>
				</li>
				...
				<?php if ( is_user_logged_in() && $order->get_user_id() === get_current_user_id() && $order->get_billing_email() ) : ?>
					<li class="woocommerce-order-overview__email email">
						...
						<strong><?php echo uncode_switch_stock_string( $order->get_billing_email() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></strong>
					</li>
				<?php endif; ?>

				<li class="woocommerce-order-overview__total total">
					<?php esc_html_e( 'Total:', 'woocommerce' ); ?>
					<strong><?php echo uncode_switch_stock_string( $order->get_formatted_order_total() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></strong>
				</li>
		...
		<?php do_action( 'uncode_woocommerce_thankyou_before_table', $order->get_id() ); ?>

		<?php if ( apply_filters( 'uncode_woocommerce_print_thankyou_table', true ) ) : ?>
