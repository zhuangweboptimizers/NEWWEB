...
<div class="yith-wcwl-wishlist-new">
    ...
    <input class="create-wishlist-button btn btn-default" type="submit" name="create_wishlist" value="<?php echo esc_attr( apply_filters( 'yith_wcwl_create_wishlist_button_label', __( 'Create wishlist', 'yith-woocommerce-wishlist' ) ) ); ?>"/>
