...
if (have_posts()):
	...
	if ($generic_body_content_block === '') {
		...
		$before_shop_loop = ob_get_clean();

		if ( $before_shop_loop === '<div class="woocommerce-notices-wrapper"></div>' ) {
			$notices = false;
		}
		...
		if ( ( $counter_content !== '' && $ordering_content !== '' ) || $the_content_product_subcategories !== '' ) {
