 ...
 */
function uncode_get_dynamic_colors_css_for_shortcode_uncode_woocommerce_my_account( $shortcode, $custom_color_keys ) {
	$accepted_keys = array(
		'my_account_nav_back_color'     => array( 'bg' ),
		'my_account_content_back_color' => array( 'bg' ),
	);
