 ...
 */
function uncode_get_dynamic_colors_css_for_shortcode_uncode_author_profile( $shortcode, $custom_color_keys ) {
	$accepted_keys = array(
		'avatar_back_color' => array( 'bg' ),
		'text_color'        => array( 'text' ),
		'button_color'      => array( 'button', 'text' ),
	);
