...
$data[ 'name' ]             = esc_html__( 'Call To Action Split Fullscreen Alt', 'uncode-wireframes' );
$data[ 'cat_name' ]         = $wireframe_categories[ 'call_to_action' ];
$data[ 'custom_class' ]     = 'call_to_action';
$data[ 'image_path' ]       = UNCDWF_THUMBS_URL . 'call-to-action/Call-To-Action-Split-Fullscreen-Alt.jpg';
