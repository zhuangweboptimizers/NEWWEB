...
jQuery(document).ready(function($) {
	...
	$(document).on('click', '#uf-font-stack li', function() {
	...
	$(document).on('change', '.uf-variant-list-cb,.uf-subset-list-cb,#uf-font-selectors', function() {
	...
	$(document).on('change', '.uf-variant-font-selector', function() {
	...
	$(document).on('click', '.uf-add-font', function() {
	...
	$(document).on('click', '.uf-download-font', function(e) {
		var button = $(this);
		var lineItem = $(this).parents('.uf-fonts-for li');
	...
	$(document).on('click', '.uf-delete-download', function(e) {
		var button = $(this);
	...
	$(document).on('click', '.uf-remove-font', function() {
