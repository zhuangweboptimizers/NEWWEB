...
vc_map(array(
	'name' => esc_html__('Filter Products by Rating', 'uncode-core') ,
	'base' => 'uncode_woocommerce_widget_top_rating_filter',
	'icon' => 'icon-wpb-woocommerce',
	'weight' => -200,
	'category' => esc_html__('WooCommerce Widgets', 'uncode-core') ,
	'description' => esc_html__('Display a list of star ratings to filter products in your store.', 'woocommerce') ,
	'params' => array(
		array(
			'type' => 'textfield',
