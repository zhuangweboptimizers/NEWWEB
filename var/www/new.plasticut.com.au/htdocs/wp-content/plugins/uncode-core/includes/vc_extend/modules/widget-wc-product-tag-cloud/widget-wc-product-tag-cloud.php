<?php
/**
 * VC Widget WC product tag cloud config
 */
...
vc_map(array(
	'name' => esc_html__('Product Tag Cloud', 'uncode-core') ,
	'base' => 'uncode_woocommerce_widget_product_tag_cloud',
	'icon' => 'icon-wpb-woocommerce',
	'weight' => -200,
	'category' => esc_html__('WooCommerce Widgets', 'uncode-core') ,
	'description' => esc_html__('A cloud of your most used product tags.', 'woocommerce') ,
	'params' => array(
		array(
			'type' => 'textfield',
