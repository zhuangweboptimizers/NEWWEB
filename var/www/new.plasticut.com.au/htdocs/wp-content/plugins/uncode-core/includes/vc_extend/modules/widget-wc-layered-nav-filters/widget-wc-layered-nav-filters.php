<?php
/**
 * VC Widget WC layered nav filters config
 */
...
vc_map(array(
	'name' => esc_html__('Products Layered Nav Filters', 'uncode-core') ,
	'base' => 'uncode_woocommerce_widget_layered_nav_filters',
	'icon' => 'icon-wpb-woocommerce',
	'weight' => -200,
	'category' => esc_html__('WooCommerce Widgets', 'uncode-core') ,
	'description' => esc_html__('Display a list of active product filters.', 'woocommerce') ,
	'params' => array(
		array(
			'type' => 'textfield',
